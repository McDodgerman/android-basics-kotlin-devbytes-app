...
import com.stargrazer.android.devbyteviewer.database.getDatabase
...
import com.stargrazer.android.devbyteviewer.network.asDomainModel
import com.stargrazer.android.devbyteviewer.repository.VideosRepository
...
class DevByteViewModel(application: Application) : AndroidViewModel(application) {
     ...
     * to the data. [[Used for refreshDataFromNetwork()]]
     */
    ...
    private fun refreshDataFromRepository() {
        viewModelScope.launch {
            try {
                ...
                // Show Toast error, hide progress bar
