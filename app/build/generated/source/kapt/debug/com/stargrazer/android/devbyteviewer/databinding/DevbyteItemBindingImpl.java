...
public class DevbyteItemBindingImpl extends DevbyteItemBinding implements com.stargrazer.android.devbyteviewer.generated.callback.OnClickListener.Listener {
    ...
    private DevbyteItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback1 = new com.stargrazer.android.devbyteviewer.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.videoCallback == variableId) {
            setVideoCallback((com.stargrazer.android.devbyteviewer.ui.VideoClick) variable);
        }
        else if (BR.video == variableId) {
            setVideo((com.stargrazer.android.devbyteviewer.domain.DevByteVideo) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVideoCallback(@Nullable com.stargrazer.android.devbyteviewer.ui.VideoClick VideoCallback) {
    ...
    public void setVideo(@Nullable com.stargrazer.android.devbyteviewer.domain.DevByteVideo Video) {
        this.mVideo = Video;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
    ...
    protected void executeBindings() {
        ...
        com.stargrazer.android.devbyteviewer.ui.VideoClick videoCallback = mVideoCallback;
        com.stargrazer.android.devbyteviewer.domain.DevByteVideo video = mVideo;
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            com.stargrazer.android.devbyteviewer.util.BindingAdaptersKt.setImageUrl(this.videoThumbnail, VideoThumbnail1);
        }
    }
