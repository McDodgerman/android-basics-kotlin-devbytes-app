...
import com.stargrazer.android.devbyteviewer.BR;
...
public class FragmentDevByteBindingImpl extends FragmentDevByteBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.stargrazer.android.devbyteviewer.viewmodels.DevByteViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.stargrazer.android.devbyteviewer.viewmodels.DevByteViewModel ViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeViewModelPlaylist((androidx.lifecycle.LiveData<java.util.List<com.stargrazer.android.devbyteviewer.domain.DevByteVideo>>) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModelPlaylist(androidx.lifecycle.LiveData<java.util.List<com.stargrazer.android.devbyteviewer.domain.DevByteVideo>> ViewModelPlaylist, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        com.stargrazer.android.devbyteviewer.viewmodels.DevByteViewModel viewModel = mViewModel;
        androidx.lifecycle.LiveData<java.util.List<com.stargrazer.android.devbyteviewer.domain.DevByteVideo>> viewModelPlaylist = null;
        java.util.List<com.stargrazer.android.devbyteviewer.domain.DevByteVideo> viewModelPlaylistGetValue = null;
        ...
        if ((dirtyFlags & 0xfL) != 0) {
            ...
            com.stargrazer.android.devbyteviewer.util.BindingAdaptersKt.hideIfNetworkError(this.loadingSpinner, androidxDatabindingViewDataBindingSafeUnboxViewModelEventNetworkError, viewModelPlaylistGetValue);
        }
    }
